                      ...
                      <div class="card-body">
                        ...
                        <div class="mb-6">
                          ...
                          <input
                            type="text"
                            class="form-control"
                            id="itinerary_activity"
                            placeholder="Itinerary Activity"
                            name="itinerary_activity"
                            aria-label="Itinerary Activity"
                        ...
                        <div class="mb-6">
                          ...
                          <input
                            type="text"
                            class="form-control"
                            id="itinerary_activity_date"
                            placeholder="Itinerary Activity Date"
                            name="itinerary_activity_date"
                            aria-label="Itinerary Activity Date"
                            value="<?php echo $itinerary['Activity_date'] ?>" />
                        </div>
                        <div class="mb-6">
