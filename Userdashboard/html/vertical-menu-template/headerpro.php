      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="view_expense.php" class="menu-link">
                  <div data-i18n="Expense List">Expense List</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="add_expense.php" class="menu-link">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="view_trip.php" class="menu-link">
                  <div data-i18n="Trip List">Trip List</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="add_trip.php" class="menu-link">
                  <div data-i18n="Add Trip">Add Trip</div>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="menu-item">
            <a href="view_report.php" class="menu-link">
              <div data-i18n="Manage Reviews">Manage Reports</div>
            </a>
          </li>
        </ul>
        </li>
